          ...
          <div className='content d_flex'>
            ...
            <div className='right box_shodow'>
              <form onSubmit={formSubmit}>
                ...
                <button className='btn_shadow' style={{textAlign: 'center', display: 'flex', alignItems: 'center', fontSize: '15px'}}>
                  SEND MESSAGE <FaLongArrowAltRight  style={{gap: 3 }} size={25}></FaLongArrowAltRight>
                </button>
              </form>
            </div>
          </div>
